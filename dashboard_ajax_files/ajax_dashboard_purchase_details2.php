...
if($_REQUEST['empid'] and $_REQUEST['empid2']) {
	$sql = "SELECT sum(HKPP.final_quantity) as quantity,HKP.name,HKP.type,HKP.quantity_type
          ...
          WHERE HKPR.bill_date BETWEEN '".$_REQUEST['empid2']."' AND '".$_REQUEST['empid']."' GROUP BY HKPP.product_id";
