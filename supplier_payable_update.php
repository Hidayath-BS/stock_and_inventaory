    ...
    <div class="container-fluid">
     <!-- customer details-->
        ...
        <form class="cust_line" method="post" action="supplier_due_module/supplier_due_update_creation_handler.php">
            <div class="row"><h5 style="margin:-8px 2px 8px 0px " ><u>Supplier Payable Update</u></h5>
        ...
        <table class="table">
          <tbody>
            <tr>
              ...
              <td>
                <input type="date" name="date" class="suppay" value="<?php echo date('Y-m-d'); ?>" required>
              </td>
            </tr>
            <tr>
              <th>
        ...
        <table class="table">
          <tbody>
            ...
            <tr>
              ...
              <td>
                <input type="text" class="duetext dueamt" name="particulars"  id="particulars">
              </td>
            </tr>
          </tbody>
        </table>
