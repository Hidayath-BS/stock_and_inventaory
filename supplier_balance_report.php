  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     <!-- customer details-->
        ...
        <form class="cust_line" method="post" action="Reports/supplier_balance_report.php">
            <h5 style="margin:-18px 0px 18px 0px " ><u>Supplier Balance Report</u></h5>
...
<!--       <button class="buttonsubmit" type="submit"><a >Continue</a></button>-->
          <!-- <button class="stbuttonreset"  type="reset"><a style="color: white;">Bac</a></button> -->
      </div>
    <!-- </div> -->
  </form>
