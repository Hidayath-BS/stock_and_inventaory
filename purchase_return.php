     ...
     <!-- customer details-->
      <div class="row">
        ...
        <!-- <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" method="post"> -->
            <h5 class="headpurchase"><u>Add Purchase Return</u></h5>
         ...
         <input type="text" class="purrtext" name="chequeNumber" id="supp_name" placeholder="Enter Supplier Name.." value="" >
...
<!--                        <input type="text"  class="salestext1" id="product_type" name="product_type" placeholder="Enter Product Type.." value="" required>-->
                        ...
                        <select id="sretpro_type" class="purtext " name="sretproduct_name" disabled >
                            <?php
...
<br>
  ...
  <div class="row pursave">
          ...
          <form action="purchase_return_module/purchase_return_creation_handler1.php" method="post" id="return_form_p">
            <input type="text" id="purchaseid" class="purtext purbill" name="purchaseid" style="display:none">
...
<!--            <input type="text" id="supplier_id" class="purtext purbill" name="supplier_id" style="display:none">-->
       <label for="bill" class="purbalance">Purchase Return Bill No<span class="requiredfield">*</span> </label>
       ...
       if($month>4){
         ...
         $calcBillQ = "select MAX(id) as billnum from `hk_purchases_return` WHERE date BETWEEN '$fromDate' and '$toDate'";
   ...
   <input type="text" id="bills" class="purtext purbill" name="purbill"  placeholder="Bill No.." value="<?php echo $billNumber; ?>" maxlength="30" required readonly>
...
<div class="row">
     ...
     <a  href="purchase_return_list.php" style="text-decoration:none;"  class="buttonreset"><span>Cancel</span></a>
    </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="container">
            ...
            <div class="col-md-4">
              <label for="md-transtype">
                Purchase Bill No: <b id="md-p-billno"></b>
              </label>
            </div>
            <div class="col-md-4">
              <label for="md-transtype">
                P-R-Bill No: <b id="md-p-r-billno"></b>
              </label>
            </div>
            <div class="col-md-4">
              <label for="md-transtype">
...
$.ajax({
    url: "get-bill-details-using-bill-no.php",
    dataType: 'Json',
     ...
     // alert('done');
      console.log(data);
        ...
        for(i =0;i<=data.length;i++){
            ...
            $('#row_'+row+2).html(data[i].final_quantity);
...
$("#balance").val(balance);
      ...
      function sformValidate(){
        ...
        function sales_form(){
          ...
          if(res == true){
              document.getElementById("return_form_p").submit();
          }
        }
