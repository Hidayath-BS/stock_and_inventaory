...
-->
      ...
      <div class="card mb-3">
        <div class="card-header"> <h6>Purchase Expense List</h6>
      <button class="pexpenceadd" onclick="myFunction()"><i class="fa fa-refresh"></i></button>
...
<!--                <th>Delete</th>-->
              ...
              <tbody>
                <?php
                             ...
                             $orderlistq ="SELECT HKPE.*,HKPR.bill_number,HKP.first_name,HKP.last_name,HKET.expenses_type
                                          FROM `hk_purchase_expenses` AS HKPE
                                          LEFT JOIN `hk_purchases` AS HKPR ON HKPE.purchase_id = HKPR.id
                                          LEFT JOIN `hk_persons` AS HKP ON HKPR.person_id = HKP.id
                                          LEFT JOIN `hk_expenses_type` AS HKET ON HKPE.expense_type_id = HKET.id  WHERE HKPE.expenses_active = '1'
                                          ORDER BY HKPE.id DESC
                                          ";
