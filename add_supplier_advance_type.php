  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     <!-- customer details-->
        ...
        <form class="cust_line" method="POST" action="supplier_advance_module/supplier_advance_type_creation_handler.php">
            <div class="row"><h5 style="margin:-8px 2px 8px 0px " ><u>Add Supplier Advance Type</u></h5> 
...
<!--            <h5 style="margin: -18px 0px 8px 0px"><u>Supplier Advances</u></h5>-->
    <div class="row">
        ...
        <input type="text"  class="advancetext advanceamount" name="type" placeholder="Type" required>
    ...
    <input  type="submit" class="buttonsubmit" value="Submit">
      <a href="supplier_advance_type_list.php" style="text-decoration: none;" class="buttonreset">Cancel</a>
     </div>
