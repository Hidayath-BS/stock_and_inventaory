  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     <!-- customer details-->
        ...
        <form class="cust_line" method="post" action="supplier_module/supplier_type_creation_handler.php">

            <div class="row"><h5 style="margin:-18px 0px 18px 0px " ><u>Add Supplier Type</u></h5>
    ...
    <div class="row">
        <div class="col-md-6">
       <label for="name">Supplier Type <span class="requiredfield">*</span></label>
   <input type="text" id="name" class="supptext" name="name" placeholder="Type" required>
      </div>
    </div>
     <div class="row">

<!--        <input  type="submit"  value="Submit">-->
<!--       <button class="buttonreset" ><a href="supplier_type_list.php" style="color: white; text-decoration:none;">Cancel</a></button>-->
