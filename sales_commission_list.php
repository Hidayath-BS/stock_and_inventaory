...
-->
      ...
      <div class="card mb-3">
        <div class="card-header">
          <h6>Sales Commission List</h6>

           <button class="commadd" onclick="myFunction()"><i class="fa fa-refresh" style="color: white;"></i></button>
            ...
            <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
              ...
              <tbody>
                <?php
                             ...
                             $listq ="SELECT HKSC.*,HKS.bill_number,HKS.total_amount_received,HKP.first_name,HKP.last_name
                             FROM `hk_sales_commission` AS HKSC
                             LEFT JOIN `hk_sales` AS HKS ON HKSC.sales_id = HKS.id
                             LEFT JOIN `hk_persons` AS HKP ON HKS.person_id = HKP.id
                             ORDER BY HKSC.id DESC
                             ";
                ...
                <tr class="custtd">
                  ...
                  <td><?php echo $row['total_amount_received']; ?></td>
