...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.7.1/css/bootstrap-datepicker.min.css" />
  ...
  <link href="css/sb-admin.css" rel="stylesheet">
    <link href="css/customer_account_statement.css" rel="stylesheet">
...
<body onload = "document.refresh();" class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <form class="cust_line" action = "Reports/customer_account_statement.php" method="post">
    <h5 style="margin: -18px 0px 8px 0px"><u>Customer Account Statement</u></h5>
    <div class="row">
    <div class="col-md-6">
        <label class="headingcas">Customer Name:</label>
...
<button class="balancesheetbutt" type="submit" formtarget="_blank"><a>View Balance Sheet </a></button>
