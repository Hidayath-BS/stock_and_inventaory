...
$print_array_index = 0;
  ...
  $query  = "SELECT id,first_name,last_name FROM  `hk_persons` WHERE person_type_id = '1' ORDER BY `first_name`";
                ...
                <?php
                                 ...
                                 foreach ($print_array as $printdata) {
                                   ...
                                   >
                                     ...
                                     <td>
                                       <form method="post" action="supplier_payable_update.php">
                                         <button name = "submit" value="<?php echo $printdata['id']; ?>" class = "dueaddbutton" ><a style="color: white;">Clear Due</a></button>
                                         </form>
                                       </td>
                               </tr>
                               <?php
