            ...
            <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
              ...
              <tbody>
                <?php
                             ...
                             WHERE HKPB.balance_amount > 0 AND HKP.person_type_id = 2";
                ...
                <tr class="custtd">
                  ...
                  <td>
                    <form method="post" action="customer_balance_update.php">
                      <button name = "submit" value="<?php echo $row['id']; ?>" class="baladdbutton"><a style="color: white;">Clear Balance</a></button>
                      </form>
                    </td>
            </tr>
            <?php
