  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     <!-- customer details-->
        ...
        <form class="cust_line" method="post" action="php_form_handler/add_quantity_handler.php">
   ...
   <input type="text" class="baltext" id="type" name="type" placeholder="Unit" required>
      </div> 
    </div>      
     <div class="row">
