    ...
    <div class="container-fluid">
     <!-- customer details-->
        ...
        <form class="cust_line" method="post" action="customer_balance_module/customer_balance_update_creation_handler.php">
              <div class="row"><h5 style="margin:-8px 2px 8px 0px " ><u>Customer Balance Update</u></h5>
   ...
   <input type="text" class="baltext balamt2" name="remainingBalance"  id="remainingdue" readonly>
     ...
     <div class="row balsubmit">
        ...
        <input  type="submit"  value="Submit" >
            <button class="buttonreset"><a href="customer_balance_list.php" style="color: white; text-decoration: none;">Cancel  </a></button>
